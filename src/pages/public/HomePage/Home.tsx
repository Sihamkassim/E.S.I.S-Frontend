    ...
    return (
        <div className="min-h-screen bg-white">
            ...
            <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${scrolled
                ...
                {mobileMenuOpen && (
                    <div className="md:hidden absolute top-full left-0 right-0 bg-white shadow-lg border-b border-gray-200 z-40">
            ...
            {/* Hero Section */}
            <AnimatedSection className="relative pt-32 pb-20 px-4 sm:px-6 lg:px-8 mx-4 sm:mx-6 lg:mx-8 overflow-hidden transition-all duration-1000 ease-out">
                ...
                <div className="max-w-5xl mx-auto text-center relative z-10">
                    ...
                    <StaggeredContainer className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6 max-w-5xl mx-auto" staggerDelay={0.1}>
                        <AnimatedSection className="bg-white/80 backdrop-blur-sm rounded-2xl p-4 sm:p-6 md:p-8 text-center shadow-lg border border-white/50 hover:shadow-xl transition-all duration-500 ease-out transform hover:-translate-y-1">
            ...
            {/* Membership Section */}
            <AnimatedSection className="py-12 sm:py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-blue-50 to-purple-50">
                <div className="max-w-4xl mx-auto">
                    <AnimatedSection className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 sm:p-8 md:p-12 border border-blue-200 relative overflow-hidden transition-all duration-1000 ease-out">
