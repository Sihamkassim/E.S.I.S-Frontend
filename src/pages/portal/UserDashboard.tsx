            ...
            <div className="max-w-7xl mx-auto space-y-6">
                ...
                <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                    <div>
                        ...
                        <p className="text-slate-600 mt-1">Welcome back! Here's your activity overview</p>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                    ...
                    <div className="bg-white rounded-xl p-8 shadow-md border border-slate-200 hover:shadow-lg transition-shadow">
                        ...
                        <p className="text-base text-slate-600 mb-3">My Projects</p>
                    ...
                    <div className="bg-white rounded-xl p-8 shadow-md border border-slate-200 hover:shadow-lg transition-shadow">
                        ...
                        <p className="text-base text-slate-600 mb-3">Applications</p>
                        <div className="flex items-center text-sm text-green-600">
                            <CheckCircle className="h-4 w-4 mr-1" />
                    ...
                    <div className="bg-white rounded-xl p-8 shadow-md border border-slate-200 hover:shadow-lg transition-shadow">
                        ...
                        <p className="text-base text-slate-600 mb-3">Upcoming Webinars</p>
                    ...
                    <div className="bg-white rounded-xl p-8 shadow-md border border-slate-200 hover:shadow-lg transition-shadow">
                        ...
                        <p className="text-base text-slate-600 mb-3">Active Membership</p>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div className="bg-white rounded-xl p-8 shadow-md border border-slate-200">
                        <div className="flex items-center gap-2 mb-6">
                            ...
                            <h3 className="text-xl font-bold text-slate-900">Monthly Activity</h3>
                        </div>
