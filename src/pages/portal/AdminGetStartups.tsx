...
const AdminGetStartups: React.FC = () => {
    ...
    return (
        <>
            <div className="max-w-7xl mx-auto p-4 sm:p-6 lg:p-8">
                <div className="mb-8">
                    <Button variant="ghost" onClick={() => navigate(-1)} className="mb-4 hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors">
                        <ArrowLeft className={`mr-2 h-4 w-4 ${theme === 'dark' ? 'text-white' : 'text-gray-900'}`} />
                        <p className={`${theme === 'dark' ? 'text-white' : 'text-gray-900'}`}>Back to Dashboard</p>
                    </Button>
